...
fn main() {
    for _ in 0..100 {
        ...
        problem.add_reaction(Rate::new(k1, &[SRate::PosHill(Edda::U5, k2*K1, n1), SRate::NegHill(Edda::U7, k3*K2, n2)]), &[1, 0, 0, 0, 0, 0]);
        problem.add_reaction(Rate::new(k1, &[SRate::PosHill(Edda::U6, k2*K1, n1), SRate::NegHill(Edda::U8, k3*K2, n2)]), &[0, 1, 0, 0, 0, 0]);
        problem.add_reaction(Rate::new(k3, &[SRate::NegHill(Edda::U1, k1*K3, n3)]), &[0, 0, 1, 0, 0, 0]);
        problem.add_reaction(Rate::new(k3, &[SRate::NegHill(Edda::U2, k1*K3, n3)]), &[0, 0, 0, 1, 0, 0]);
        problem.add_reaction(Rate::new(k2, &[SRate::NegHill(Edda::U1, k1*K4, n4)]), &[0, 0, 0, 0, 1, 0]);
        problem.add_reaction(Rate::new(k2, &[SRate::NegHill(Edda::U2, k1*K4, n4)]), &[0, 0, 0, 0, 0, 1]);
