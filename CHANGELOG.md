...
## [0.10.1](https://github.com/Armavica/rebop/compare/rebop-v0.10.0...rebop-v0.10.1) - 2026-08-24

### Miscellaneous

- Restrict permissions for pre-commit workflow

## [0.10.0](https://github.com/Armavica/rebop/compare/rebop-v0.9.7...rebop-v0.10.0) - 2026-08-24

### Added

- Add a function to advance the system by n reactions
- Add a function to advance for n reactions or until tmax
...
- Fix advance_until to do nothing if tmax < t
...
- Add a DOI badge in the README and fix CITATION.cff
- Upgrade Rust dependencies
- Upgrade Python dependencies
- Upgrade GitHub actions
- Apply zizmor recommendations to rust CI
