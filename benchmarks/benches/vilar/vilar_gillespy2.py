...
class VilarOscillator(gillespy2.Model):  # type: ignore[misc]
    def __init__(self, parameter_values: None = None) -> None:
        ...
        r1 = gillespy2.Reaction(
            name="r1", reactants={"A": 1, "R": 1}, products={"C": 1}, rate="gammaC"
        )
        r2 = gillespy2.Reaction(
            name="r2", reactants={"A": 1}, products={}, rate="deltaA"
        )
        r3 = gillespy2.Reaction(
            name="r3", reactants={"C": 1}, products={"R": 1}, rate="deltaA"
        )
        r4 = gillespy2.Reaction(
            name="r4", reactants={"R": 1}, products={}, rate="deltaR"
        )
        ...
        r7 = gillespy2.Reaction(
            name="r7", reactants={"Da": 1}, products={"Da": 1, "Ma": 1}, rate="alphaA"
        )
        ...
        r9 = gillespy2.Reaction(
            name="r9", reactants={"Ma": 1}, products={}, rate="deltaMA"
        )
        r10 = gillespy2.Reaction(
            name="r10", reactants={"Ma": 1}, products={"A": 1, "Ma": 1}, rate="betaA"
        )
        ...
        r13 = gillespy2.Reaction(
            name="r13", reactants={"Dr": 1}, products={"Dr": 1, "Mr": 1}, rate="alphaR"
        )
        ...
        r15 = gillespy2.Reaction(
            name="r15", reactants={"Mr": 1}, products={}, rate="deltaMR"
        )
        r16 = gillespy2.Reaction(
            name="r16", reactants={"Mr": 1}, products={"Mr": 1, "R": 1}, rate="betaR"
        )
...
results = model.run(gillespy2.SSACSolver, number_of_trajectories=90)
print(results)
# results.plot()
# plt.show()
